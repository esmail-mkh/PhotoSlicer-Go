...
(function initFilenamePreview() {
    ...
    window.refreshFilenamePreview = refreshPreview;
    refreshPreview();
})();
...
function updateSettings() {
    ...
    const settings = {
        ...
        height_limit: parseInt(document.getElementById('height-input').value) || 16000,
...
const PRESET_FIELD_DEFS = [
    ...
    { key: 'height_limit', id: 'height-input', type: 'int', def: 16000 },
    ...
    { key: 'enhance_engine', id: 'enhance-engine-select', type: 'value', def: 'fast' },
    ...
    { key: 'output_suffix', id: 'output-suffix', type: 'value', def: ' [Stitched]' },
    { key: 'filename_pattern', id: 'filename-pattern', type: 'value', def: '[number]' },
    { key: 'filename_digits', id: 'filename-digits', type: 'int', def: 3 },
